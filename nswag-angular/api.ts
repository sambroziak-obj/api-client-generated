...
export class Client {
     ...
     * @param body (optional) 
     */
    updatePetWithForm(petId: number, body: Blob | undefined): Observable<void> {
        let url_ = this.baseUrl + "/pet/{petId}";
        if (petId === undefined || petId === null)
            throw new Error("The parameter 'petId' must be defined.");
        url_ = url_.replace("{petId}", encodeURIComponent("" + petId));
     ...
     * @return successful operation
     */
    uploadFile(petId: number, additionalMetadata: string | undefined, file: FileParameter | undefined): Observable<ApiResponse> {
